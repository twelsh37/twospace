// frontend/scripts/optimize-database-ssl-fix.js
// Database Optimization Script for Asset Management System using Supabase
// Alternative SSL configuration for better compatibility
...
// Database connection configuration for Supabase with robust SSL handling
const pool = new Pool({
...
async function main() {
  ...
  try {
    console.log("🚀 Starting Supabase database optimization (SSL Fixed)...");
    console.log("=======================================================\n");
