...
declare module "expo-router" {
  ...
  // prettier-ignore
  type StaticRoutes = `/` | `/(tabs)/assets` | `/assets` | `/(tabs)/dashboard` | `/dashboard` | `/(tabs)/profile` | `/profile` | `/(tabs)/scanner` | `/scanner` | `/login`;
  // prettier-ignore
  type DynamicRoutes<T extends string> = `/asset/${SingleRoutePart<T>}/edit` | `/asset/${SingleRoutePart<T>}` | `/user/${SingleRoutePart<T>}`;
  // prettier-ignore
  type DynamicRouteTemplate = `/asset/[id]/edit` | `/asset/[id]` | `/user/[id]`;
